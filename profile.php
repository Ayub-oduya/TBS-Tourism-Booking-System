...
<html>
<head>
<title>Three Birds Safaris | Tourism Management System</title>
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Update Details</h3>
...
<?php }} ?>
<h3 class="prnt"><a href="change-password.php">Change Password</a></h3>
			<p style="width: 350px;">
